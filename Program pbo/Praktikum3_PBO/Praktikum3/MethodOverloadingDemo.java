public class MethodOverloadingDemo {
    ...
    public static void main(String[] args) {
        /* Memanggil method max dengan parameter masukan integer */
        System.out.println("Angka terbesar dari 3 dan 9 adalah " + max(3, 9));

        /* Memanggil method max dengan parameter masukan double */
        System.out.println("Angka terbesar dari 4.25 dan 4.0 adalah " + max(4.25, 4.0));

        /* Memanggil method max dengan parameter masukan 3 double */
